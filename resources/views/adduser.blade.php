...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('اضافه کردن کاربر جدید') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('userstore') }}">
                        ...
                        <div class="col-md-6">
                                <input id="tnphone" type="text" class="form-control @error('tnphone') is-invalid @enderror" name="tnphone" value="{{ old('ssn') }}" required autocomplete="ssn" autofocus>
                        ...
                        <div class="col-md-6">
                                <input id="buytype" type="text" class="form-control @error('buytype') is-invalid @enderror" name="buytype" value="{{ old('buytype') }}" required autocomplete="buytype" autofocus>
                        ...
                        <label for="role" >نقش کاربری  </lable>
                        <select name="role" class="form-control">
                            <option  value="1" >ادمین کل </option>
                            <option  value="2" >   ادمین میانی </option>

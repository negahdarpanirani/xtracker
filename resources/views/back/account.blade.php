...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>کنترل پنل کاربر</b></span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <!-- <a href="https://github.com/hosseinizadeh/AdminLTE_Persian" class="btn hidden-xs" style="margin:6px 100px;padding:9px 50px;background-color:#d61577;border-color:#ad0b5d;font-weight:bold;color:#FFF">   </a> -->
      <!-- End Delete-->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">منوی  مدیریت ردیاب ها</li>
        <!-- Optionally, you can add icons to the links -->

          <a href="{{route('account')}}"><i class="fa fa-link"></i> <span>حساب داری</span>
          <li><a href="{{route('admin')}}"><i class="fa fa-link"></i> <span> مدیریت</span>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('store')}}">
                        ...
                        <div class="form-group row">
                            <label for="buyamount" class="col-md-4 col-form-label text-md-right">{{ __('مبلغ خرید ') }}</label>
                            <div class="col-md-6">
                                <input id="buyamount" type="text" class="form-control @error('buyamount') is-invalid @enderror" name="buyamount" value="{{ old('buyamount') }}" required autocomplete="buyamount" autofocus>
                                @error('buyamount')
                        ...
                        <div class="form-group row">
                            <label for="selamount" class="col-md-4 col-form-label text-md-right">{{ __('مبلغ فروش ') }}</label>
                            <div class="col-md-6">
                                <input id="selamount" type="text" class="form-control @error('selamount') is-invalid @enderror" name="selamount" value="{{ old('selamount') }}" required autocomplete="selamount" autofocus>
                                @error('selamount')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="selamount2" class="col-md-4 col-form-label text-md-right">{{ __('هزینه حمل ونقل') }}</label>
                            <div class="col-md-6">
                                <input id="selamount2" type="text" class="form-control @error('selamount2') is-invalid @enderror" name="selamount2" value="{{ old('selamount2') }}" required autocomplete="selamount2" autofocus>
                                @error('selamount2')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="model " class="col-md-4 col-form-label text-md-right">{{ __('مدل دستگاه ') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="number" class="col-md-4 col-form-label text-md-right">{{ __('تعداد خرید ') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="cedertype" class="col-md-4 col-form-label text-md-right">{{ __('نوع ارز ') }}</label>
                            <div class="col-md-6">
                                <input id="cedertype" type="text" class="form-control @error('cedertype') is-invalid @enderror" name="cedertype" value="{{ old('cedertype') }}" required autocomplete="cedertype" autofocus>
                                @error('cedertype')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="dayrate" class="col-md-4 col-form-label text-md-right">{{ __('نرخ روز ارز ') }}</label>
                            <div class="col-md-6">
                                <input id="dayrate" type="text" class="form-control @error('dayrate') is-invalid @enderror" name="dayrate" value="{{ old('dayrate') }}" required autocomplete="dayrate" autofocus>
                                @error('yuan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            <label for="price" class="col-md-4 col-form-label text-md-right">{{ __('بها') }}</label>
                            <div class="col-md-6">
...
<table class="table">
  <thead>
    <tr>
        ...
        <td>مبلغ خرید </td>
        <td> مبلغ فروش </td>
        <td>هزینه حمل ونقل   </td>
        <td>مدل دستگاه</td>
        <td>تعداد موجود در انبار  </td>
        <td>نوع ارز </td>
        <td> نرخ روز ارز </td>
        <td> بها </td>
        <td> معادل ریالی </td>
    ...
    <tr>
        ...
        <td>{{$cat->buyamount}}</td>
        <td>{{$cat->selamount}} </td>
        <td>{{$cat->selamount2}} </td>
        <td>{{$cat->model}} </td> 
        <td>{{$cat->number}} </td> 
        <td>{{$cat->cedertype}} </td> 
        <td>{{$cat->dayrate }} </td> 
        <td>{{$cat->price }} </td> 
        <td>{{ $cat->price  * $cat->dayrate}} </td> 
        <td><a class="btn btn-danger"href="{{route('acdestroy',$cat->id)}}"

  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="#"><i class="fa fa-link"></i> <span>ویرایش مشخصات دستگاه</span></a></li>
        <li><a href="#"><i class="fa fa-link"></i> <span>حذف دستگاه</span></a></li>
        <li><a href="#"><i class="fa fa-link"></i> <span>آمار</span></a></li>
        <li class="treeview">
         <li class="treeview">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('store')}}">
                        ...
                        <div class="form-group row">
                            <label for="yuan" class="col-md-4 col-form-label text-md-right">{{ __('قیمت یوآن در زمان خرید ') }}</label>
                            <div class="col-md-6">
                                <input id="yuan" type="text" class="form-control @error('yuan') is-invalid @enderror" name="yuan" value="{{ old('yuan') }}" required autocomplete="yuan" autofocus>
                                @error('yuan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>

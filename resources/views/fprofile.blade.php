        ...
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="../../public/images/1584465419.jpeg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        علیرضا
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"> ویرایش اطلاعات کاربران</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">منوی پروفایل</li>
        <!-- Optionally, you can add icons to the links -->
        <li ><a href="{{route('account')}}"> مدیریت</a></li>
...
<div class="d-flex justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                        ...
                        <div class="form-group row">
                            <label for="ssn" class="col-md-4 col-form-label text-md-right">{{ __('کد ملی ') }}</label>
                        <div class="col-md-6">
                                <input id="ssn" type="text" value="{{$user->ssn}}" class="form-control @error('ssn') is-invalid @enderror" name="ssn" value="{{ old('ssn') }}" required autocomplete="ssn" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('شماه تلفن ') }}</label>
                        <div class="col-md-6">
                                <input id="phone"  value="{{$user->phone}}" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="tnphone" class="col-md-4 col-form-label text-md-right">{{ __('شماره سیم کارت دستگاه') }}</label>
                        <div class="col-md-6">
                                <input id="tnphone" value="{{$user->tnphone}}" type="text" class="form-control @error('tnphone') is-invalid @enderror" name="tnphone" value="{{ old('ssn') }}" required autocomplete="ssn" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="buytype" class="col-md-4 col-form-label text-md-right">{{ __('نوع خرید') }}</label>
                        <div class="col-md-6">
                                <input id="buytype" value="{{$user->buytype}}" type="text" class="form-control @error('buytype') is-invalid @enderror" name="buytype" value="{{ old('buytype') }}" required autocomplete="buytype" autofocus>
                        ...
                        <div class="form-group row">
                        <label for="role" class="col-md-4 col-form-label text-md-right">نقش کاربری  </lable>
                        <select name="role" class="form-control">
                            <option class="col-md-4 col-form-label text-md-right" value="1" <?php if($user->role==1)echo 'selected'?>>ادمین کل </option>
                            <option class="col-md-4 col-form-label text-md-right" value="2" <?php if($user->role==2)echo 'selected'?>>   ادمین میانی </option>
                            <option class="col-md-4 col-form-label text-md-right" value="3" <?php if($user->role==3)echo 'selected'?>>  کاربر  </option>
                         </select>
        </div>
 ...
 <div class="col-md-6"><button type="submit" class="btn btn-success">بارگزاری</button></div> </div> </form>
    </div>
</div>
